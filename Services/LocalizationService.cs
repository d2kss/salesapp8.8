...
namespace Securitas8._8.Services
{
    public class LocalizationService
    {
        ...
        public LocalizationService(ILocalizationLoader loader, IlocalizationRepository locRepo)
        {
            _loader = loader;
            _locRepo = locRepo;
        }
        ...
        {
            var json =  _locRepo.LoadJson(language);//await _loader.LoadJsonAsync(language);
